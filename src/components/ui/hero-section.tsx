    ...
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden bg-background">
      ...
      <div className="relative z-10 container mx-auto px-4 text-center">
        <div className="max-w-4xl mx-auto animate-fade-in">
          <h1 className="font-poppins text-4xl md:text-6xl lg:text-7xl font-bold mb-6 leading-tight tracking-tight">
            Transforme seu
            <span className="font-poppins block mt-2">
              negócio em referência.
            </span>
          </h1>
          
          <p className="text-lg md:text-xl lg:text-xl text-gray-300 mb-8 max-w-3xl mx-auto">
